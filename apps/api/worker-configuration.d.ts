/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ad9a2615f70bab99efbbea5e6ff557ac)
// Runtime types generated with workerd@1.20250428.0 2025-04-30 
declare namespace Cloudflare {
	interface Env {
		DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").WebSocketServer>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
